...
public class TMTlocal : UdonSharpBehaviour
{
    ...
    public void useme()
    {
        ...
        {
            usualuseclass.LoadTextToString(SavedText, ref SavedString);//从Text读取到questions
            usualuseclass.SetRandomString(ref SavedString,SavedString.Length);//打乱questions数组
